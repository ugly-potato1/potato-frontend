  ...
  return (
    <div className="wrapper">
      <div className="main__container">
        <img className="banner__image1" src={Image01}></img>
        <div className="sub__title">다채롭기만한.</div>
        <div className="sub__container1">
          <img className="banner__image2" src={Image02}></img>
        </div>
        <div className="sub__title">싸고 맛있는.</div>
        <div className="sub__container2">
          <img className="banner__image3" src={Image03}></img>
          <img className="banner__image4" src={Image04}></img>
        </div>
        ...
        <div className="sub__container3">
          ...
          <div className="user__wrap">
            <img className="banner__image5" src={Image05}></img>
            <div className="shadow">
              <button class="button__sample1">마을구출 동참하기</button>
              <button class="button__sample2">마을구출 동참하기</button>
            </div>
          </div>
